...
const translations = {
  en: {
    ...
    proj1_desc: "Smart travel app simulation and optimized tourism itinerary planning.",
  ...
  pt: {
    ...
    proj1_desc: "Simulação de aplicativo de viagens e planejamento inteligente de roteiros turísticos.",

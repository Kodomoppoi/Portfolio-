...
const translations = {
  en: {
    ...
    proj1_desc: "Automated property data extraction, cleaning and analytical processing pipeline.",
  ...
  pt: {
    ...
    proj1_desc: "Pipeline automatizado de extração, estruturação e análise de dados imobiliários.",

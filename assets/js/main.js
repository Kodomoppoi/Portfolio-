...
const translations = {
  en: {
    ...
    res_ch1_desc: " Lower-cost and free tier providers (such as Groq) enforce strict TPM/RPM limits (e.g. 6,000 TPM). Required architecting a micro-batching execution pipeline with smart rate-limiting to prevent quota exhaustion.",
    res_ch2_title: "DOM Condensation & Token Economy:",
    res_ch2_desc: " Raw portal HTML consumes tens of thousands of unnecessary tokens. Modified the scraper to pre-process and strip DOM noise, cutting ~75% of text payload before dispatching to the LLM.",
    res_ch3_title: "Model Quirks (e.g. Qwen <think> Reasoning Blocks):",
    res_ch3_desc: " Certain open-weights reasoning models inject unsolicited thinking tokens (<think>) that corrupt JSON responses. Implemented strict output sanitizers to preserve clean deserialization.",
    res_ch4_title: "Smaller Models & Strict Prompt Anchoring:",
    res_ch4_desc: " Cheaper and smaller models tend to hallucinate or drop fields without severe constraints. Built prompt anchoring techniques and schema enforcement via Pydantic to maintain structured consistency.",
    res_learn_title: "Key Learnings & Disciplines",
    res_badge_scraping: "Advanced Web Scraping",
    res_badge_ai_arch: "AI Orchestration & Prompt Architecture",
    ...
    res_learn_item3: "Architecting and commanding controlled AI workflows: prompt anchoring, structured output schemas, and fail-fast resilience.",
  ...
  pt: {
    ...
    res_ch1_desc: " Modelos em camadas gratuitas ou de menor custo (como Groq) impõem limites severos de requisição e TPM (ex: 6.000 TPM). Foi necessário arquitetar processamento em micro-batches com throttling inteligente para não estourar quotas.",
    res_ch2_title: "Condensação de Texto & Economia de Tokens:",
    res_ch2_desc: " O HTML bruto de portais consome dezenas de milhares de tokens desnecessários. Modifiquei o scraper para realizar limpeza prévia do DOM, reduzindo cerca de 75% do ruído antes de enviar o payload para a IA.",
    res_ch3_title: "Vícios de Modelos (ex: Módulo <think> do Qwen):",
    res_ch3_desc: " Certos modelos de raciocínio inserem blocos não solicitados de reflexão (<think>) que poluem a resposta. Desenvolvi tratamentos de sanitização para garantir JSONs puros prontos para desserialização.",
    res_ch4_title: "Modelos Menores e Necessidade de Ancoragem Rígida:",
    res_ch4_desc: " Modelos mais compactos e baratos tendem a alucinar ou ignorar campos sem constraints severas. Implementei técnicas rigorosas de ancoragem de prompt e validação com Pydantic para manter a integridade dos dados.",
    res_learn_title: "O que Aprendi",
    res_badge_scraping: "Web Scraping Avançado",
    res_badge_ai_arch: "Orquestração & Comandos de IA",
    ...
    res_learn_item3: "Arquitetar e comandar fluxos de IA controlados, combinando ancoragem de prompts, esquemas estruturados e tolerância a falhas.",
